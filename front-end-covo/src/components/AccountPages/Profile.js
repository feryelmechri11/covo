      ...
      <div>
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="desc">Bonjour, je m'appelle Feryel !</p>
            <p className="desc">Membre depuis juillet 2020</p>
            <p>
              <a href="#" className="social-icon facebook">
                <i className="fab fa-facebook-f"></i> Facebook verifié
              </a>
              <a href="#" className="social-icon twitter">
                <i className="fab fa-twitter"></i> Numéro de téléphone vérifié
              </a>
              <a href="#" className="social-icon tumblr">
                <i className="fab fa-tumblr"></i> Adresse email vérifié
              </a>
              <a href="#" className="social-icon youtube">
                <i className="fab fa-youtube"></i>Pièce d’identité vérifiée
              </a>
            </p>
          </div>
          <div className="card-footer">
            <div className="col vr">
              <p>
                <span className="count">1.8K</span> Followers
              </p>
            </div>
            <div className="col">
              <p>
                <span className="count">2.0K</span> Following
              </p>
            </div>
          </div>
        </div>
